...
export default function Messages() {
  return (
    <div className="flex relative flex-col h-screen bg-[#F8F8F8] text-sm text-muted-foreground">
      {/* Scrollable Content */}
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 pt-6 pb-44">
      ...
      <div className="static bottom-0 left-0 w-full bg-white border-t border-gray-200 px-4 sm:px-6 lg:px-8 py-4 z-50">
